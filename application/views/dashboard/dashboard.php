                ...
                <div class="card card-danger">
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-sm table-hover">
                      ...
                      <?php $files = $this->db->query("select * from attachments where collection_id = '$row->collection_id' order by collection_id desc ")->result(); ?>
                      <?php if ($files) : ?>
                        <tr>
                          <th></th>
                          <th>Files</th>
                        ...
                        <?php foreach ($files as $file) : ?>
                          ...
                          <td class="text-right"><?php echo $file->upload_date; ?></td>
                          </tr>
                        <?php endforeach; ?>
                      <?php endif; ?>
                    <?php endforeach; ?>
                ...
                <?php if ($level == 'admin') : ?>
                  <div class="col-md-4">
                    <div class="card card-secondary">
                      <div class="card-header">
                        <h3 class="card-title">Total Files per Departments (Admin Only)</h3>
                      </div>
                      <div class="card-body">
